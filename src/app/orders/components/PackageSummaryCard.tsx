    ...
    <div className="flex flex-col overflow-hidden rounded-lg border border-[#DADADA] bg-[#FDFFFF]">
      <div className="px-5 py-3.5 border-b border-[#DADADA] bg-[#FEFCFA]">
        <h3 className="text-base 2xl:text-xl font-medium text-[#232323]">
          {translate("customerOrder.summaryCards.package", currentLocale)}
        </h3>
      </div>
      <div className="p-5 flex flex-col gap-3 text-sm">
        <div className="flex items-start text-sm 2xl:text-xl">
          <span className="text-[#7B7B7B] w-36 2xl:w-46 flex-shrink-0">
            {translate("customerOrder.summaryCards.value", currentLocale)}
          </span>
        ...
        <div className="flex items-start text-sm 2xl:text-xl">
          <span className="text-[#7B7B7B] w-36 2xl:w-46 flex-shrink-0">
            {translate("customerOrder.summaryCards.dimensions", currentLocale)}
          </span>
        ...
        <div className="flex items-start text-sm 2xl:text-xl">
          <span className="text-[#7B7B7B] w-36 2xl:w-46 flex-shrink-0">
            {translate("customerOrder.summaryCards.weight", currentLocale)}
          </span>
        ...
        <div className="flex items-start text-sm 2xl:text-xl">
          <span className="text-[#7B7B7B] w-36 2xl:w-46 flex-shrink-0">
            {translate("customerOrder.summaryCards.volumeWeight", currentLocale)}
          </span>
        ...
        <div className="flex items-start text-sm 2xl:text-xl">
          <span className="text-[#7B7B7B] w-36 2xl:w-46 flex-shrink-0">
            {translate("customerOrder.summaryCards.hsCode", currentLocale)}
          </span>
