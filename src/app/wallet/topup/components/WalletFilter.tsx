...
export default function WalletFilter({
  ...
  return (
    ...
    >
      ...
      <div
        className="col-span-24 md:col-span-18 flex flex-wrap items-center gap-3 justify-start"
        style={{ gridColumn: "span 18 / span 18" }}
      >
      ...
      <div
        className="col-span-24 md:col-span-6 flex items-center justify-end"
