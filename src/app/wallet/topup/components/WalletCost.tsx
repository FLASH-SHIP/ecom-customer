      ...
      <CardContent className="px-5 py-4 flex flex-col justify-between h-full">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-1.5 text-muted-foreground">
            <span className={'text-sm 2xl:text-base font-medium'}>{translate("customerWallet.paid", currentLocale)}</span>
            <span className="text-foreground font-semibold">$368.00</span>
          </div>
          <div className="flex items-center gap-1.5 text-muted-foreground">
            <span className={'text-sm 2xl:text-base font-medium'}>{translate("customerWallet.pending", currentLocale)}</span>
