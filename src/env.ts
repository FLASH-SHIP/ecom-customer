...
const processEnv = {
  ...
  FACEBOOK_CLIENT_ID: process.env.FACEBOOK_CLIENT_ID || process.env.AUTH_FACEBOOK_ID,
  FACEBOOK_CLIENT_SECRET: process.env.FACEBOOK_CLIENT_SECRET || process.env.AUTH_FACEBOOK_SECRET,
