      ...
      async authorize(credentials) {
        ...
        try {
          ...
          return {
            ...
            isTermsAccepted: (user as any).isTermsAccepted !== undefined ? Boolean((user as any).isTermsAccepted) : true,
          };
        } catch (error) {
  ...
  callbacks: {
    ...
    async jwt({ token, user, account, trigger, session }) {
      ...
      if (isSocialProvider) {
        ...
        token.isTermsAccepted = (user as any).isTermsAccepted !== undefined ? Boolean((user as any).isTermsAccepted) : true;
      }
